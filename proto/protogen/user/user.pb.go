...
const file_user_user_proto_rawDesc = "" +
	"\n" +
	"\x0fuser/user.proto\"v\n" +
	"\bUserData\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x04R\x02id\x12\x1a\n" +
	"\busername\x18\x02 \x01(\tR\busername\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x14\n" +
	"\x05email\x18\x04 \x01(\tR\x05email\x12\x14\n" +
	"\x05phone\x18\x11 \x01(\tR\x05phone\"\x18\n" +
	"\x06UserID\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x04R\x02id2T\n" +
	"\vUserService\x12 \n" +
	"\n" +
	"CreateUser\x12\t.UserData\x1a\a.UserID\x12#\n" +
	"\rFetchUserByID\x12\a.UserID\x1a\t.UserDataB:Z8github.com/akanshgupta98/BlogProject/proto/protogen/userb\x06proto3"
...
var file_user_user_proto_depIdxs = []int32{
	0, // 0: UserService.CreateUser:input_type -> UserData
	1, // 1: UserService.FetchUserByID:input_type -> UserID
	1, // 2: UserService.CreateUser:output_type -> UserID
	0, // 3: UserService.FetchUserByID:output_type -> UserData
